...
export function About() {
  return <InfoPage title="A quieter way to practice" description="Dictation is a focused text-to-speech workspace for reading practice, language learning, transcription, and careful listening." path="/about" eyebrow="ABOUT / 01">
